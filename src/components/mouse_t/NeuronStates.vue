...
import NeuronStatesDesc from '@/components/mouse_t/NeuronStatesDesc.vue'
import NeuronFeaturePlots from '@/components/mouse_t/NeuronFeatureScatter.vue'
import NeuronFeatureHistogramBars from '@/components/mouse_t/NeuronFeatureHistogramBars.vue'
