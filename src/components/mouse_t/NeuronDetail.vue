...
import NeuronStates from '@/components/mouse_t/NeuronStates.vue'
import NeuronInfo from '@/components/mouse_t/NeuronInfo.vue'
import MultiNeuronsViewer from '@/components/mouse_t/MultiNeuronsViewer.vue'
import { ElTabPane } from 'element-ui/types/tab-pane'
import NeuronFeatureMap from '@/components/mouse_t/NeuronFeatureMap.vue'
