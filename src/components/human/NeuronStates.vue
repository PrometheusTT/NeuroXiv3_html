...
import NeuronStatesDesc from '@/components/human/NeuronStatesDesc.vue'
import NeuronFeaturePlots from '@/components/human/NeuronFeatureScatter.vue'
import NeuronFeatureHistogramBars from '@/components/human/NeuronFeatureHistogramBars.vue'
