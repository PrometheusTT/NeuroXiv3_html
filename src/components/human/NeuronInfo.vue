...
import NeuronScene from '@/components/human/NeuronScene.vue'
import SliceSection from '@/components/human/SliceSection.vue'
import ROI from '@/components/human/ROI.vue'
import Soma from '@/components/human/Soma.vue'
import ColorPicker from '@/components/human/ColorPicker.vue'
